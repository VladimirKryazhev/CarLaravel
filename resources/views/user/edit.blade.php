        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a href="{{ route('user.index') }}" class="btn btn-dark col-md-2" role="button">Назад к каталогу</a>


                        <form method="POST" action="{{ route('user.update', $car) }}" enctype="multipart/form-data">
